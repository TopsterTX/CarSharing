    ...
    <section className="slider">
      <div className={`slider__wrapper slider__wrapper--${value}`}>
        <div className="slider__container" id="slider-hidden">
          <Arrow className="arrow__next" setValue={setValue} val={value} id='next'/>
          <ContentSlider value={value} />
          <Arrow className="arrow__prev" setValue={setValue} val={value} id='prev'/>
        </div>
      </div>
    </section>
  );
